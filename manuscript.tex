...
\begin{figure}
    ...
    \caption{Atom parity with one suppressed hydrogen. The central atom (cyan) has a suppressed hydrogen. In this case, the root atom (r) is regarded as the first child and analysis continues as before.}
