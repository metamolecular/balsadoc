...
\begin{figure}
    ...
    \caption{Gratuitous selection. These heteroatoms are selected but don't need to be because subvalence is zero in every case. When such atoms are selected, they must be pruned before processing the DS.}
